...
public class OutputCommandHandler {
	...
	public void logout(String token) throws IOException {
		oos.writeObject(
				MessageBuilder.build(null, null, LOGOUT, null, null, token, null, null, null, null, null, null, null));
	}
	...
	public void addUser(User user, String token) throws NoSuchAlgorithmException, IOException {
		...
		oos.writeObject(MessageBuilder.build(null, null, ADD_USER, null, null, token, null, null, user, null, null,
				null, null));
	}
	...
	public void addSchedule(Schedule sched, String token) throws NoSuchAlgorithmException, IOException {
		oos.writeObject(MessageBuilder.build(null, null, ADD_SCHEDULE, null, null, token, null, null, null, sched, null,
				null, null));
	}
	...
	public void addBillboard(Billboard billboard, String token) throws IOException {
		oos.writeObject(MessageBuilder.build(null, null, ADD_BILLBOARD, null, null, token, null, null, null, null, null,
				null, billboard));
	}
	...
	public void editUser(User user, String token) throws NoSuchAlgorithmException, IOException {
		...
		oos.writeObject(MessageBuilder.build(null, null, UPDATE_USER, null, null, token, null, null, user, null, null,
				null, null));
	}
	...
	public void deleteUser(User user, String token) throws NoSuchAlgorithmException, IOException {
		oos.writeObject(MessageBuilder.build(null, null, DELETE_USER, null, null, token, null, null, user, null, null,
				null, null));
	}
	...
	public void deleteBillboard(Billboard blbrd, String token) throws IOException {
		...
		oos.writeObject(MessageBuilder.build(null, null, DELETE_BILLBOARD, null, null, token, null, null, null, null,
				null, null, blbrd));
	}
	...
	public void editBillboard(Billboard blrd, String token) throws IOException {
		oos.writeObject(MessageBuilder.build(null, null, EDIT_BILLBOARD, null, null, token, null, null, null, null,
				null, null, blrd));
	}
	...
	public void allUsers(String token) throws IOException {
		oos.writeObject(
				MessageBuilder.build(null, null, USERS, null, null, token, null, null, null, null, null, null, null));
	}
	...
	public void allSchedules(String token) throws IOException {
		oos.writeObject(MessageBuilder.build(null, null, SCHEDULES, null, null, token, null, null, null, null, null,
				null, null));
	}
	...
	public void allBillboards(String token) throws IOException {
		oos.writeObject(MessageBuilder.build(null, null, BILLBOARDS, null, null, token, null, null, null, null, null,
				null, null));
	}
